...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(Lh/b0/d/g;)V
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lj/h;Lj/g;)V
    ...
    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lj/h;)V
...
.method private final detachTimeout(Lj/m;)V
    ...
    .line 1
    invoke-virtual {p1}, Lj/m;->a()Lj/e0;

    move-result-object v0

    .line 2
    sget-object v1, Lj/e0;->NONE:Lj/e0;

    invoke-virtual {p1, v1}, Lj/m;->b(Lj/e0;)Lj/m;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v0, p1, v1}, Lh/h0/l;->p(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()Lj/b0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lj/d0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lj/d0;
    .locals 2
...
.method private final newKnownLengthSink()Lj/b0;
    .locals 2
...
.method private final newUnknownLengthSource()Lj/d0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lj/b0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lj/b0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lj/b0;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lj/d0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lj/d0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lj/d0;
    ...
    .line 5
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lj/d0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lj/d0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lj/g;->D(Ljava/lang/String;)Lj/g;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lj/g;->D(Ljava/lang/String;)Lj/g;
    ...
    .line 7
    invoke-interface {v3, v0}, Lj/g;->D(Ljava/lang/String;)Lj/g;
