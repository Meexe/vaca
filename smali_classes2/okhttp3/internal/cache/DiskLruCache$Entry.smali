...
.method private final newSource(I)Lj/d0;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lj/d0;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Lj/d0;Lj/d0;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lj/d0;
...
.method public final writeLengths$okhttp(Lj/g;)V
    ...
    .line 2
    invoke-interface {p1, v5}, Lj/g;->u(I)Lj/g;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lj/g;->a0(J)Lj/g;
