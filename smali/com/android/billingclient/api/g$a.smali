...
.method synthetic constructor <init>(Lcom/android/billingclient/api/x;)V
    ...
    iput p1, p0, Lcom/android/billingclient/api/g$a;->d:I
...
.method public a()Lcom/android/billingclient/api/g;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/g$a;->e:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/billingclient/api/g$a;->e:Ljava/util/ArrayList;
    ...
    .line 12
    invoke-virtual {v8}, Lcom/android/billingclient/api/SkuDetails;->q()Ljava/lang/String;
    ...
    .line 20
    invoke-virtual {v8}, Lcom/android/billingclient/api/SkuDetails;->t()Ljava/lang/String;
    ...
    .line 23
    invoke-direct {v0, v3}, Lcom/android/billingclient/api/g;-><init>(Lcom/android/billingclient/api/x;)V

    iget-object v3, p0, Lcom/android/billingclient/api/g$a;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, Lcom/android/billingclient/api/SkuDetails;->t()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/billingclient/api/g;->n(Lcom/android/billingclient/api/g;Z)Z
    ...
    .line 27
    invoke-static {v0, v1}, Lcom/android/billingclient/api/g;->g(Lcom/android/billingclient/api/g;Ljava/lang/String;)Ljava/lang/String;

    iget v1, p0, Lcom/android/billingclient/api/g$a;->d:I

    .line 28
    invoke-static {v0, v1}, Lcom/android/billingclient/api/g;->c(Lcom/android/billingclient/api/g;I)I

    iget-object v1, p0, Lcom/android/billingclient/api/g$a;->e:Ljava/util/ArrayList;

    .line 29
    invoke-static {v0, v1}, Lcom/android/billingclient/api/g;->k(Lcom/android/billingclient/api/g;Ljava/util/ArrayList;)Ljava/util/ArrayList;

    iget-boolean v1, p0, Lcom/android/billingclient/api/g$a;->f:Z
...
.method public c(Ljava/lang/String;)Lcom/android/billingclient/api/g$a;
    ...
    iput-object p1, p0, Lcom/android/billingclient/api/g$a;->c:Ljava/lang/String;

    return-object p0
.end method

.method public d(Lcom/android/billingclient/api/SkuDetails;)Lcom/android/billingclient/api/g$a;
    .locals 1
    ...
    iput-object v0, p0, Lcom/android/billingclient/api/g$a;->e:Ljava/util/ArrayList;

    return-object p0
.end method

.method public e(Lcom/android/billingclient/api/g$b;)Lcom/android/billingclient/api/g$a;
    .locals 1
    ...
    .line 2
    invoke-virtual {p1}, Lcom/android/billingclient/api/g$b;->b()I
