...
.method private h(Ljava/io/InputStream;Lj/g;)V
    .locals 6
    ...
    .line 2
    invoke-interface {p2, v1, v4, v5}, Lj/g;->H([BII)Lj/g;
...
.method j(Ljava/lang/String;)Lcom/RNFetchBlob/a;
    ...
    .line 3
    sget-object p1, Lcom/RNFetchBlob/g$e;->g:Lcom/RNFetchBlob/g$e;
...
.method public writeTo(Lj/g;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/RNFetchBlob/a;->h(Ljava/io/InputStream;Lj/g;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
